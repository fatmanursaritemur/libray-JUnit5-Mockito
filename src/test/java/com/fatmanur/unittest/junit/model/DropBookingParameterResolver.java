...
public class DropBookingParameterResolver implements ParameterResolver {

    private static Logger logger = Logger.getLogger(DropBookingParameterResolver.class.getName());

    @Override
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {

        if (parameterContext.getParameter().getType() == Member.class && parameterContext.getIndex() == 1) {
            return true;
        }
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        ...
        if (parameterContext.getParameter().getType() == Member.class) {
            return new Member("id1", "Nur", "Yilmaz");
        }
